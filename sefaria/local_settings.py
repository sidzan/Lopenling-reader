...
print(">>>>>>>>>>>>>>>>>redis")
print(os.getenv("REDIS_HOST", "ENV_NAME not defined"))
print(">>>>>>>>>>>>>>>>>redis")
################
...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/sijan/personal/sefaria/Sefaria-Project/tmp/db.sqlite', # Path to where you would like the database to be created including a file name, or path to an existing database file if using sqlite3.
...
CACHES = {
    "shared": {
        ...
        "LOCATION": os.getenv("REDIS_HOST", "ENV_NAME not defined"), #"redis://127.0.0.1:6379/1", #The URI used to look like this "127.0.0.1:6379:0"
        "OPTIONS": {
    ...
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": os.getenv("REDIS_HOST", "ENV_NAME not defined"), #"redis://127.0.0.1:6379/0", #The URI used to look like this "127.0.0.1:6379:0"
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
